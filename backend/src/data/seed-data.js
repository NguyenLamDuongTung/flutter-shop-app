    ...
    products: [
      {
        ...
        description:
          'Lightweight backpack with a padded laptop sleeve.',
        category: 'Bags',
        price: 49.9,
        stock: 12,
        imageUrl:
      ...
      },
      {
        ...
        name: 'Classic Watch',
        description:
          'Clean dial and durable leather strap.',
      ...
      },
      {
        ...
        description:
          'Over-ear headphones with rich, balanced sound.',
      ...
      },
      {
        ...
        name: 'Cotton Hoodie',
        description:
          'Soft mid-weight hoodie for cool evenings.',
        category: 'Clothing',
        price: 39.9,
        stock: 20,
        imageUrl:
      ...
      },
      {
        ...
        name: 'Travel Bottle',
        description:
          'Insulated stainless-steel bottle, 600 ml.',
        category: 'Accessories',
        price: 24,
        stock: 15,
        imageUrl:
          'https://images.unsplash.com/photo-1602143407151-7111542de6e8?w=900',
      },
    ],
